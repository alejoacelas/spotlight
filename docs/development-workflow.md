...
- `scripts/check.sh` runs the complete local release gate. `--ci` omits the signed keyboard smoke test and installation.
...
- The parent workspace generator records Launcher and its ignored Sol reference clone without absorbing either repository.
